...
custom_headers = ["Ranking", "Lenguaje", "Rating", "Cambio", "Cambio", "Cambio", "Cambio"]  # Modifica estos títulos según tus necesidades
...
df.to_excel('tiobe_index.xlsx', index=False)